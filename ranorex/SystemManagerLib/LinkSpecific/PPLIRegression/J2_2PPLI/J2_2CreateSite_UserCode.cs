...
namespace SystemManagerLib.LinkSpecific.PPLIRegression.J2_2PPLI
{
	...
	/// </summary>
	public partial class J2_2CreateSite
	{
		static J2_2CreateSite()
		{
		...
		{	
			Accessible accElement = new Accessible(repo.FormSystem_Manager___UNCLASS.TextUnit);  
		   	...
		   	TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.UnitNum = UnitNum;
		}
		...
		public void CheckBoxIndirect_PPLI()
		{
			if (repo.FormSystem_Manager___UNCLASS.CheckBoxIndirect_PPLI.Checked == true)
			{
				...
				repo.FormSystem_Manager___UNCLASS.CheckBoxIndirect_PPLI.Click("CenterLeft");
			}
		}		
			...
			while (x < 2)
			{
				try
				{
					...
					Ranorex.List listBox = "/form[@title='sm']/element/element/list[@accessiblerole='List']";
		       		listBox.Items[3].Select();
		       		listBox.Items[3].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Env = EnvValue;
	   				Report.Info("Environment Value Entered = " + EnvValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Env_OOO = false;
		   			x=2;		   			
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Env_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Plat = PlatValue;
	   				Report.Info("Platform Value Entered = " + PlatValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Plat_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Plat_OOO = true;
			   		}
				}					
			}			
		}	
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.PlatAct = PlatActValue;
	   				Report.Info("Platform Activity Value Entered = " + PlatActValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.PlatAct_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.PlatAct_OOO = true;
			   		}
				}					
			}			
		}			
			...
			while (x < 2)
			{
				try
				{
					...
					if (ASnum == 3)
					{
	   				...
	   				TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.NPS = NPSValue.ToUpper();
	   				Report.Info("NPS Value Entered = " + NPSValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.NPS_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.NPS_OOO = true;
			   		}
				}					
			}			
		}	
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.SiteType = SiteTypeValue;
	   				Report.Info("Site Type Value Entered = " + SiteTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.SiteType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.SiteType_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
	   				...
	   				TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.GenericUnitType = GenericUnitTypeValue.ToUpper();
	   				Report.Info("Generic Unit Type Value Entered = " + GenericUnitTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.GenericUnitType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.GenericUnitType_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Strength = StrengthValue;
	   				Report.Info("Strength Value Entered = " + StrengthValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Strength_OOO = false;
		       		x=2;
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Strength_OOO = true;
			   		}
				}					
			}			
		}
		...
		public void Mode2()
		{
			...
			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Mode2 = d;
		...
		public void Mode3()
		{
			CommonUtilLib.Util myfunction = new CommonUtilLib.Util();
			CommonUtilLib.Util SharedFunctions = new CommonUtilLib.Util();
			string a = SharedFunctions.Random(1, 4095);
			string b = SharedFunctions.DecimalToBase(Convert.ToInt32(a), 8);
			Keyboard.Press(b);
			int c = Convert.ToInt32(b);
			string d = c.ToString("D4");
			TacViewLib.LinkSpecific.PPLIRegression.J2_2PPLI.J2_2ValidateSite.Mode3 = d;
