...
using Ranorex;
using Ranorex.Core;
namespace SystemManagerLib.LinkSpecific.PPLIRegression.J2_3PPLI
{
	/// <summary>
	/// The CreateSite recording.
	/// </summary>
	public partial class J2_3CreateSite
	{
		static J2_3CreateSite()
		{
		...
		{		
			Accessible accElement = new Accessible(repo.FormSystem_Manager___UNCLASS.TextUnit);  
		   	...
		   	TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.UnitNum = UnitNum;
		}
			...
			while (x < 2)
			{
				try
				{
					...
					Ranorex.List listBox = "/form[@title='sm']/element/element/list[@accessiblerole='List']";
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Env = EnvValue;
	   				Report.Info("Environment Value Entered = " + EnvValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Env_OOO = false;
		   			x=2;		   			
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Env_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Plat = PlatValue;
	   				Report.Info("Platform Value Entered = " + PlatValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Plat_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Plat_OOO = true;
			   		}
				}					
			}			
		}	
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.PlatAct = PlatActValue;
	   				Report.Info("Platform Activity Value Entered = " + PlatActValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.PlatAct_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.PlatAct_OOO = true;
			   		}
				}					
			}			
		}			
			...
			while (x < 2)
			{
				try
				{
					...
					if (ASnum == 3)
					{
	   				...
	   				TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.NPS = NPSValue.ToUpper();
	   				Report.Info("NPS Value Entered = " + NPSValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.NPS_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.NPS_OOO = true;
			   		}
				}					
			}			
		}	
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.SiteType = SiteTypeValue;
	   				Report.Info("Site Type Value Entered = " + SiteTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.SiteType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.SiteType_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
	   				...
	   				TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.GenericUnitType = GenericUnitTypeValue.ToUpper();
	   				Report.Info("Generic Unit Type Value Entered = " + GenericUnitTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.GenericUnitType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.GenericUnitType_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Strength = StrengthValue;
	   				Report.Info("Strength Value Entered = " + StrengthValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Strength_OOO = false;
		       		x=2;
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Strength_OOO = true;
			   		}
				}					
			}			
		}
		...
		public void Mode2()
		{
			...
			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Mode2 = d;
		...
		public void Mode3()
		{
			...
			int c = Convert.ToInt32(b);
			string d = c.ToString("D4");
			TacViewLib.LinkSpecific.PPLIRegression.J2_3PPLI.J2_3ValidateSite.Mode3 = d;
