...
using Ranorex;
using Ranorex.Core;
namespace SystemManagerLib.LinkSpecific.PPLIRegression.J2_0PPLI
{
	/// <summary>
	/// The CreateSite recording.
	/// </summary>
	public partial class J2_0CreateSite
	{
		static J2_0CreateSite()
		{
		...
		{		
			Accessible accElement = new Accessible(repo.FormSystem_Manager___UNCLASS.TextUnit);  
		   	...
		   	TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.UnitNum = UnitNum;
		}
		...
		{
			if (repo.FormSystem_Manager___UNCLASS.CheckBoxIndirect_PPLI.Checked == false)
			{
		...
		public void Environment()
		{
			...
			while (x < 2)
			{
				try
				{
					...
					int ASnum = ASvalue.Next(0, count++);
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Env = EnvValue;
	   				Report.Info("Environment Value Entered = " + EnvValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Env_OOO = false;
		   			x=2;		   			
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Env_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Plat = PlatValue;
	   				Report.Info("Platform Value Entered = " + PlatValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Plat_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Plat_OOO = true;
			   		}
				}					
			}			
		}	
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.PlatAct = PlatActValue;
	   				Report.Info("Platform Activity Value Entered = " + PlatActValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.PlatAct_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.PlatAct_OOO = true;
			   		}
				}					
			}			
		}			
			...
			while (x < 2)
			{
				try
				{
					...
					if (ASnum == 3)
					{
	   				...
	   				TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.NPS = NPSValue.ToUpper();
	   				Report.Info("NPS Value Entered = " + NPSValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.NPS_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.NPS_OOO = true;
			   		}
				}					
			}			
		}	
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.SiteType = SiteTypeValue;
	   				Report.Info("Site Type Value Entered = " + SiteTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.SiteType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.SiteType_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
	   				...
	   				TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.GenericUnitType = GenericUnitTypeValue.ToUpper();
	   				Report.Info("Generic Unit Type Value Entered = " + GenericUnitTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.GenericUnitType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.GenericUnitType_OOO = true;
			   		}
				}					
			}			
		}
			...
			while (x < 2)
			{
				try
				{
					...
					listBox.Items[ASnum].Click();
		   			...
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Strength = StrengthValue;
	   				Report.Info("Strength Value Entered = " + StrengthValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Strength_OOO = false;
		       		x=2;
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Strength_OOO = true;
			   		}
				}					
			}			
		}
		...
		public void Mode2()
		{
			...
			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Mode2 = d;
		...
		public void Mode3()
		{
			...
			int c = Convert.ToInt32(b);
			string d = c.ToString("D4");
			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.Mode3 = d;
			...
			while (x < 2)
			{
				try
				{
					...
					int ASnum = ASvalue.Next(1, count++);
		       		listBox.Items[ASnum].Select();
		       		listBox.Items[ASnum].Click();
//		       		if (repo.FormSystem_Manager___UNCLASS.ComboBox_SpecificType.Text == "NS")
//		       		{
//		       			SpecificType();
//		       		}
		   			Accessible accElement = new Accessible(repo.FormSystem_Manager___UNCLASS.ComboBox_SpecificType);  
	   				string SpecTypeValue = accElement.Value;
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.SpecType = SpecTypeValue;
	   				Report.Info("Specific Type Value Entered = " + SpecTypeValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.SpecType_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		if (x == 1)
			   		{
			   			Report.Debug("List Count Out of Range for Secific Type, Re-Executing Function");
			   			Report.Debug(e.ToString());	
			   		}
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.SpecType_OOO = true;
			   		}
				}					
			}			
		}
		...
		//************************************************************************************//
		//***********************Enters Random Active Indicator Value*************************//
		//************************************************************************************//
			...
			while (x < 2)
			{
				try
				{
					...
					int ASnum = ASvalue.Next(0, count++);
		       		listBox.Items[ASnum].Select();
		       		listBox.Items[ASnum].Click();
		   			Accessible accElement = new Accessible(repo.FormSystem_Manager___UNCLASS.ComboBox_ActiveIndicator);  
	   				string ActiveIndValue = accElement.Value;
		   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.ActiveInd = ActiveIndValue;
	   				Report.Info("Active Indicator Value Entered = " + ActiveIndValue);
		       		TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.ActiveInd_OOO = false;
		   			x=2;		   			
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		if (x == 1)
			   		{
			   			Report.Debug("List Count Out of Range for Active Indicator, Re-Executing Function");
			   			Report.Debug(e.ToString());	
			   		}
			   		else if (x == 2)
			   		{
			   			Report.Debug("List Count Out of Range for Active Indicator, List Item Will Not be Validated");
			   			Report.Debug(e.ToString());
			   			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.ActiveInd_OOO = true;
			   		}
				}					
			}			
		}	
		...
		//************************************************************************************//
		//*********************Enters Random Position Time Quality Value**********************//
		//************************************************************************************//
		
		public void PositionTimeQuality()
		{		
			CommonUtilLib.Util SharedFunctions = new CommonUtilLib.Util();
			string a = SharedFunctions.Random(0, 16);
			Keyboard.Press(a);
			TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI.J2_0ValidateSite.PosTimeQuality = a;
   			Report.Info("Position Time Quality Value Entered = " + a);
		}
