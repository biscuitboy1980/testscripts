...
{
    /// <summary>
    /// The TNBLK1 recording.
    /// </summary>
    [TestModule("f31a2e1d-1949-44b9-b7f5-947a283e7a02", ModuleType.Recording, 1)]
    public partial class TNBLK1 : ITestModule
    {
        /// <summary>
        ...
        static TNBLK1 instance = new TNBLK1();
...
#region Variables
        ...
        /// </summary>
        [TestVariable("ee47048a-2531-40ac-bb90-bcc98525a73a")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Tab}{Back}{Tab}{Back}{Tab}{Back}{Tab}{Back}'.", new RecordItemIndex(13));
            Keyboard.Press("{Tab}{Back}{Tab}{Back}{Tab}{Back}{Tab}{Back}");
            Delay.Milliseconds(0);
