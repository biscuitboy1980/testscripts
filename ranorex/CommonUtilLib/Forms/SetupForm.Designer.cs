...
namespace CommonUtilLib.Forms
{
	partial class SetupForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Will this system be injecting or validating data?";
			// 
			// groupBox1
			// 
			...
			// numericUpDown1
			// 
			this.numericUpDown1.Location = new System.Drawing.Point(10, 108);
			...
			this.label4.Text = "Server/Client Mode";
			// 
			// comboBox2
			// 
			...
			this.comboBox2.Items.AddRange(new object[] {
									"Server",
									"Client"});
			this.comboBox2.Location = new System.Drawing.Point(7, 171);
			...
			this.Name = "SetupForm";
			this.Text = "Communicating Script Setup";
