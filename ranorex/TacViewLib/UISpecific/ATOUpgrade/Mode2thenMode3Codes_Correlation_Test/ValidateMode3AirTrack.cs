...
{
	/// <summary>
	/// The ValidateMode3AirTrack recording.
	/// </summary>
	public partial class ValidateMode3AirTrack
	{
		...
		public void Start()
		{
			...
			ValidateMode3AirTrack.CreateTrackRepoItems();
			Delay.Milliseconds(0);
			ValidateMode3AirTrack.RightClickTrack();
			Delay.Milliseconds(0);
			ValidateMode3AirTrack.ViewTrackProperties();
			Delay.Milliseconds(0);
			...
			Delay.Milliseconds(0);
			ValidateMode3AirTrack.Validate_DropTrack();
			Delay.Milliseconds(0);
			ValidateMode3AirTrack.ResetPaths();
			Delay.Milliseconds(0);
		}
