...
{
	/// <summary>
	/// The CreateSurfaceModeCodes recording.
	/// </summary>
	[TestModule("1eaa0ace-5e55-4eb0-b90c-10eb61d5df05", ModuleType.Recording, 1)]
	public partial class CreateSurfaceModeCodes : ITestModule
	{
		/// <summary>
		...
		static CreateSurfaceModeCodes instance = new CreateSurfaceModeCodes();

		/// <summary>
		/// Constructs a new instance.
		/// </summary>
		public CreateSurfaceModeCodes()
		{
		}
		...
		/// </summary>
		public static CreateSurfaceModeCodes Instance
		{
			get { return instance; }
		}
...
#region Variables
		...
		void ITestModule.Run()
		{
			...
			repo.FormTOAD.MenuItemSurface.Click(100);
			Delay.Milliseconds(0);
