...
namespace TacViewLib.UISpecific.CriticalAreas
{
	...
	/// </summary>
	public partial class CriticalAreaCrash01
	{		
		public int TCount;
		...
		{
			Report.Info("Validating Exists on item 'FormTacViewC2____map__Defaul.TitleBarTacViewC2____map__Defaul'.");
			Validate.Exists(repo.FormTacViewC2____map__Defaul.TitleBarTacViewC2____map__DefaulInfo, Validate.DefaultMessage, false);
		}
