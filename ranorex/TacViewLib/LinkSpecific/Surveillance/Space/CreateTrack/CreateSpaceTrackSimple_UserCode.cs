...
namespace TacViewLib.LinkSpecific.Surveillance.Space.CreateTrack
{
	...
	public partial class CreateSpaceTrackSimple
	{				
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMain__Space_TN.ListItemIdentity);  
		   			...
		   			ValidateTrack.ValidateSpaceTrackSimple.ID = IDValue;
		   			Report.Info("Identity Entered = " + IDValue);
		   			ValidateTrack.ValidateSpaceTrackSimple.ID_OOR = false;
		   			x=2;
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSpaceTrackSimple.ID_OOR = true;
			   		}
				}					
			}
		}		
		...
		{			
			try
			{
			    ...
			    Accessible pic1 = @"/form[@title~'^TacViewC2\ \ \ \(map:\ .*']/element/container/picture[@accessiblevalue='Track']" + "[" + TCount + "]";
	   			...
	   			ValidateTrack.ValidateSpaceTrackSimple.TrackNum = track1;
	   			Drop_Track.DropTrack.TrackNum = track1;   		
			}
			catch (Exception)
            {
				ValidateTrack.ValidateSpaceTrackSimple.ExitFlag1 = true;
				ValidateTrack.ValidateSpaceTrackSimple.ExitFlag2 = true;
