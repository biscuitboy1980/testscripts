...
namespace TacViewLib.LinkSpecific.Surveillance.Space.CreateTrack
{
	...
	{		
		...
		//************************************************************************************//
		//***************************Gets Random Identity value*******************************//
		//************************************************************************************//
		
		public void IDval()
		{
			repo.FormMain__Space_TN___CREATE.ListItemIdentity.Click("CenterLeft");
			...
			Accessible accElement = new Accessible(repo.FormMain__Space_TN___CREATE.ListItemIdentity);  
   			string IDValue = accElement.Value;
   			ValidateTrack.ValidateSpaceTrack6016D.ID = IDValue;
		}
		...
		public void Platval()
		{
			repo.FormMain__Space_TN___CREATE.ListItemPlatform.Click("CenterLeft");
		    Keyboard.Press(Keys.Tab);			
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSpaceTrack6016D.PlatFlag=false;
        	...
        	if (!found)
        	{
	        	ValidateTrack.ValidateSpaceTrack6016D.PlatFlag=true;
		...
		public void Actval()
		{
			repo.FormMain__Space_TN___CREATE.ListItemActivity.Click("CenterLeft");
		    Keyboard.Press(Keys.Tab);				
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSpaceTrack6016D.ActFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Act )
           		{
        	...
        	if (!found)
        	{
	        	ValidateTrack.ValidateSpaceTrack6016D.ActFlag=true;
	           	repo.ListRealView.Self.Items[1].Select();
	       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		{
			repo.FormMain__Space_TN___CREATE.ListItemSpecific_Type.Click("CenterLeft");
		    Keyboard.Press(Keys.Tab);				
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSpaceTrack6016D.StypeFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Stype )
           		{
        	...
        	if (!found)
        	{
	        	ValidateTrack.ValidateSpaceTrack6016D.StypeFlag=true;
	           	repo.ListRealView.Self.Items[1].Select();
	       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		//************************************************************************************//
		//******************Gets Space Amplification value from csv file**********************//
		//************************************************************************************//
		
		public void Sampval()
		{
			repo.FormMain__Space_TN___CREATE.ListItemSpace_Amplification.Click("CenterLeft");
		    Keyboard.Press(Keys.Tab);				
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSpaceTrack6016D.SampFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Samp )
           		{
        	...
        	if (!found)
        	{
	        	ValidateTrack.ValidateSpaceTrack6016D.SampFlag=true;
	           	repo.ListRealView.Self.Items[1].Select();
	       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}		
		...
		//************************************************************************************//
		//***************************Gets Random Data Indicator value*************************//
		//************************************************************************************//
		
		public void DataInd()
		{
			repo.FormMain__Space_TN___CREATE.ListItemData_Indicator.Click("CenterLeft");
		    Keyboard.Press(Keys.Tab);
		    Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			Ranorex.List list2 = "//list[@processname='RealView']";
            int AScount = list2.Items.Count;
			...
			int ASnum = ASvalue.Next(1, AScount++);
       		repo.ListRealView.Self.Items[ASnum].Select();
       		repo.ListRealView.Self.Items[ASnum].Click();
			Accessible accElement = new Accessible(repo.FormMain__Space_TN___CREATE.ListItemData_Indicator);  
   			string DIValue = accElement.Value;
   			ValidateTrack.ValidateSpaceTrack6016D.DI = DIValue;
		}	
		...
		{			
			...
			string track1 = accElement.Name;
	 		...
	 		ValidateTrack.ValidateSpaceTrack6016D.TrackNum = track1;
