...
namespace TacViewLib.LinkSpecific.Surveillance.Space.ValidateTrack
{
	...
	public partial class ValidateSpaceTrackSimple
	{	
			...
			if (!ExitFlag2)
			{
				...
				{				
					if (Link11 == true)
					{
						...
						Report.Info("Validating AttributeEqual (Text='(L11ID)') on item 'TrackDialogue.Container5019.ListItemIdentity'.");
		...
		static ValidateSpaceTrackSimple()
		{
