...
{
    public partial class ValidateSpaceTrackL16_L11
 	{
		...
		{
			Accessible accElement = new Accessible(repo.FormMain__Space_TN.ListItemSource_Type);  
		...
		public void ValidateTrackType()
		{
			if (Link11 == true)
			{
				Report.Info("Validating AttributeEqual (AccessibleValue='L11 Air') on item 'FormMain__Space_TN.ListItemTrack_Type'.");
				Validate.Attribute(repo.FormMain__Space_TN.ListItemTrack_TypeInfo, "AccessibleValue", "L11 Air", Validate.DefaultMessage, false);
			}
			else
			{
				Report.Info("Validating AttributeEqual (AccessibleValue='Air') on item 'FormMain__Space_TN.ListItemTrack_Type'.");
				Validate.Attribute(repo.FormMain__Space_TN.ListItemTrack_TypeInfo, "AccessibleValue", "Air", Validate.DefaultMessage, false);
			}
		}		
		
		//************************************************************************************//
		//******************Validates Space ID, Platform, and Activity Value******************//
		//************************************************************************************//
		...
		public void ValidateSpace()
		{
			if (!ID_OOR && !Plat_OOR && !Act_OOR)
			{
					...
					ForwardingFunctions.Convert_SpaceL16_L11(ID, Plat, Act, out L11ID, out L11PriAmp, out L11IDAmp);					
				...
				else
				{
					...
					ForwardingFunctions1.Convert_SpaceL11_L16(L11ID, L11PriAmp, L11IDAmp, out L16ID, out L16Plat, out L16Act);	
					Report.Info("Validating AttributeEqual (Text='(ID)') on item 'repo.FormMain__Air_TN.ListItemIdentityInfo'.");
