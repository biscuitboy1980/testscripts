...
{
    /// <summary>
    /// The ValidateAmpNoStatementTOAD2 recording.
    /// </summary>
    [TestModule("6eb7e631-8f6f-41d0-897e-9b67c88a0d3c", ModuleType.Recording, 1)]
    public partial class ValidateAmpNoStatementTOAD2 : ITestModule
    {
        /// <summary>
        ...
        static ValidateAmpNoStatementTOAD2 instance = new ValidateAmpNoStatementTOAD2();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ValidateAmpNoStatementTOAD2()
        {
        }
        ...
        /// </summary>
        public static ValidateAmpNoStatementTOAD2 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormMain__Reference_Point_TN.ButtonCLOSE' at 7;7.", repo.FormMain__Reference_Point_TN.ButtonCLOSEInfo, new RecordItemIndex(5));
            repo.FormMain__Reference_Point_TN.ButtonCLOSE.Click("7;7");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Right Click item 'FormTacViewC2.PictureTrack1' at Center.", repo.FormTacViewC2.PictureTrack1Info, new RecordItemIndex(6));
            repo.FormTacViewC2.PictureTrack1.Click(System.Windows.Forms.MouseButtons.Right);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormRealView.MenuItemConnection1' at Center.", repo.FormRealView.MenuItemConnection1Info, new RecordItemIndex(7));
            repo.FormRealView.MenuItemConnection1.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormConnection1.MenuItemDrop_Track' at Center.", repo.FormConnection1.MenuItemDrop_TrackInfo, new RecordItemIndex(8));
            repo.FormConnection1.MenuItemDrop_Track.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'RealViewDialog.ButtonYes' at 20;8.", repo.RealViewDialog.ButtonYesInfo, new RecordItemIndex(9));
