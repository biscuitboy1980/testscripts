...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Validate_ListItemEnviron_Category_Amplifi1();
            Delay.Milliseconds(250);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 6.7m.", new RecordItemIndex(4));
            Delay.Duration(400000, false);
            
            Validate_ListItemEnviron_Category_Amplifi2();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormMain__Reference_Point_TN.ButtonCLOSE' at 7;7.", repo.FormMain__Reference_Point_TN.ButtonCLOSEInfo, new RecordItemIndex(6));
            repo.FormMain__Reference_Point_TN.ButtonCLOSE.Click("7;7");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Right Click item 'FormTacViewC2.PictureTrack1' at Center.", repo.FormTacViewC2.PictureTrack1Info, new RecordItemIndex(7));
            repo.FormTacViewC2.PictureTrack1.Click(System.Windows.Forms.MouseButtons.Right);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormRealView.MenuItemConnection1' at Center.", repo.FormRealView.MenuItemConnection1Info, new RecordItemIndex(8));
            repo.FormRealView.MenuItemConnection1.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormConnection1.MenuItemDrop_Track' at Center.", repo.FormConnection1.MenuItemDrop_TrackInfo, new RecordItemIndex(9));
            repo.FormConnection1.MenuItemDrop_Track.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'RealViewDialog.ButtonYes' at 20;8.", repo.RealViewDialog.ButtonYesInfo, new RecordItemIndex(10));
