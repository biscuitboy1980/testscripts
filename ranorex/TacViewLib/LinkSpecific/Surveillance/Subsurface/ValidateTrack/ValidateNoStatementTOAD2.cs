...
namespace TacViewLib.LinkSpecific.Surveillance.Subsurface.ValidateTrack
{
	...
	public partial class ValidateNoStatementTOAD2
	{
		...
		public static void Start()
		{
			...
			Validate.Attribute(repo.FormMain__SubSurface_TN.ListItemSpecific_TypeInfo, "Text", "Specific Type");
			Delay.Milliseconds(100);
			Report.Info("Validating AttributeEqual (AccessibleValue='RESET TO NO STATEMENT') on item 'FormMain__SubSurface_TN.ListItemSpecific_Type'.");
			Validate.Attribute(repo.FormMain__SubSurface_TN.ListItemSpecific_TypeInfo, "AccessibleValue", "RESET TO NO STATEMENT");
			Delay.Milliseconds(100);
			Report.Info("Mouse Left Click item 'FormMain__SubSurface_TN.ButtonCLOSE' at 10;5.");
			repo.FormMain__SubSurface_TN.ButtonCLOSE.Click("10;5", 300);
			Delay.Milliseconds(0);
			Report.Info("Mouse Right Click item 'FormTacViewC2____map__Pacifi1.PictureTrack1' at Center.");
			repo.FormTacViewC2____map__Pacifi1.PictureTrack1.Click(MouseButtons.Right, 300);
			Delay.Milliseconds(0);
