...
namespace TacViewLib.LinkSpecific.Surveillance.Subsurface.ValidateTrack
{
	...
	public partial class ValidateSubSurfaceTrack6016D
	{
		...
		{
			Report.Info("Validating AttributeEqual (AccessibleValue='Friend') on item 'FormMain__SubSurface_TN.ListItemIdentity'.");
		...
		public void ValidatePlat()
		{
			if (!PlatFlag)
			{			
				Report.Info("Validating AttributeEqual (Text='Platform') on item 'FormMain__SubSurface_TN.ListItemPlatform'.");
		...
		public void ValidateAct()
		{
			if (!ActFlag)
			{
				Report.Info("Validating AttributeEqual (AccessibleValue='Activity') on item 'FormMain__SubSurface_TN.ListItemActivity'.");
			...
			{
				Report.Info("Validating AttributeEqual (Text='Activity') on item 'FormMain__SubSurface_TN.ListItemActivity'.");
		...
		//*******************************************************************************************//
		//*******************Validates Specitic Type from csv file***********************************//
		//*******************************************************************************************//
		...
		public void ValidateStype()
		{
			if (!StypeFlag)
			{
				Report.Info("Validating AttributeEqual (Text='Specific Type') on item 'FormMain__SubSurface_TN.ListItemSpecific_Type'.");
			...
			{
				Report.Info("Validating AttributeEqual (Text='Specific Type') on item 'FormMain__SubSurface_TN.ListItemSpecificType.");
		...
		static ValidateSubSurfaceTrack6016D()
		{
