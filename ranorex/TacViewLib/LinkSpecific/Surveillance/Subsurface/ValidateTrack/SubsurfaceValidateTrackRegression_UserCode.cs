...
namespace TacViewLib.LinkSpecific.Surveillance.Subsurface.ValidateTrack
{
	...
	public partial class SubsurfaceValidateTrackRegression
	{
		...
		public void ValidateDepth()
		{
			...
			Report.Info("Allowable Deviation = +/- 25 Units");
			Validate.IsTrue((Convert.ToDouble(RxDepth) > Convert.ToDouble(Depth) - 25) && (Convert.ToDouble(RxDepth) < Convert.ToDouble(Depth) + 25), Validate.DefaultMessage, false);
		}
		...
		public void ValidateCourse()
		{
			...
			Validate.Attribute(repo.FormMain__SubSurface_TN.ListItemTrue_CourseInfo, "AccessibleValue", Crs, Validate.DefaultMessage, false);
		}
		...
		public void ValidateSPI()
		{
			...
			{				
				...
				Validate.Attribute(repo.FormMain__SubSurface_TN.ListItemSpecialProcessingInfo, "AccessibleValue", SPI, Validate.DefaultMessage, false);
			}
		}
		...
		static SubsurfaceValidateTrackRegression()
		{
