...
{
    public partial class CreateSubsurfaceTrackL16_L11
    {
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMainCreate.ListItemIdentity);  
		   			...
		   			ValidateTrack.ValidateSubsurfaceTrackL16_L11.ID = IDValue;
		   			Report.Info("Identity Entered = " + IDValue);
		   			ValidateTrack.ValidateSubsurfaceTrackL16_L11.ID_OOR = false;
		   			x=2;
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSubsurfaceTrackL16_L11.ID_OOR = true;
			   		}
				}			
			}
		}
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMainCreate.ListItemActivity);  
		   			...
		   			ValidateTrack.ValidateSubsurfaceTrackL16_L11.Act = ActValue;
		   			Report.Info("Activity Value Entered = " + ActValue);
		   			ValidateTrack.ValidateSubsurfaceTrackL16_L11.Act_OOR = false;
		   			x=2;
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSubsurfaceTrackL16_L11.Act_OOR = true;
			   		}
				}					
			}
		}		
...
//			}
		...
		{			
			...
			string track1 = accElement.Name;
	 		...
	 		ValidateTrack.ValidateSubsurfaceTrackL16_L11.TrackNum = track1;
