	...
	{		
		...
		public void Platval()
		{
			...
			int ASnum = ASvalue.Next(1, AScount);
   			...
   			ValidateTrack.ValidateResetNoStatementTOAD2.Plat = PlatValue;
		}
		...
		public void Actval()
		{
			...
			int ASnum = ASvalue.Next(1, AScount);
   			...
   			ValidateTrack.ValidateResetNoStatementTOAD2.Act = ActValue;
		}
		...
		public void Stypeval()
		{
			...
			int ASnum = ASvalue.Next(1, AScount);
   			...
   			ValidateTrack.ValidateResetNoStatementTOAD2.Stype = StypeValue;       		
		}
