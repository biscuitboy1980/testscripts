...
namespace TacViewLib.LinkSpecific.Surveillance.Surface_Disused.CreateTrack
{
	...
	public partial class CreateSurfaceTrackDisused6016D
	{
		...
		public void IDval()
		{
			repo.FormMain__Surface_TN___CREATING.ListItemIdentity.Click("CenterLeft");
			...
			Accessible accElement = new Accessible(repo.FormMain__Surface_TN___CREATING.ListItemIdentity);  
   			string IDValue = accElement.Value;
   			ValidateTrack.ValidateSurfaceTrackDisused6016D.ID = IDValue;
		}
		...
		public void Platval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSurfaceTrackDisused6016D.PlatFlag=false;
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateSurfaceTrackDisused6016D.PlatFlag=true;
		...
		public void Actval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSurfaceTrackDisused6016D.ActFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Act )
           		{
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateSurfaceTrackDisused6016D.ActFlag=true;
           	repo.ListRealView.Self.Items[1].Select();
       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		public void Stypeval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSurfaceTrackDisused6016D.StypeFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Stype )
           		{
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateSurfaceTrackDisused6016D.StypeFlag=true;
           	repo.ListRealView.Self.Items[1].Select();
       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		public void Samtype()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSurfaceTrackDisused6016D.SamFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Sam )
           		{
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateSurfaceTrackDisused6016D.SamFlag=true;
           	repo.ListRealView.Self.Items[1].Select();
       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		static CreateSurfaceTrackDisused6016D()
		{
