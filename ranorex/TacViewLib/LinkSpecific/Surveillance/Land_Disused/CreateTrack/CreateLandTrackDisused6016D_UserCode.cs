...
namespace TacViewLib.LinkSpecific.Surveillance.Land_Disused.CreateTrack
{
	...
	public partial class CreateLandTrackDisused6016D
	{
		public static string Ind;
		public static string ID;
		
		//************************************************************************************//
		//********************Gets POINT/TRACK Indicator value from csv file*******************************//
		//************************************************************************************//
		...
		public void Indval()
		{
			...
			Accessible accElement = new Accessible(repo.FormMain__Land_Point_Track_TN.ListItemPoint_Track_Ind);  
   			...
   			ValidateTrack.ValidateLandTrackDisused6016D.Ind = IndValue;
		...
		public void IDval()
		{
			...
			Accessible accElement = new Accessible(repo.FormMain__Land_Point_Track_TN.ListItemIdentity);  
   			...
   			ValidateTrack.ValidateLandTrackDisused6016D.ID = IDValue;
		...
		public void Platval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateLandTrackDisused6016D.PlatFlag=false;
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateLandTrackDisused6016D.PlatFlag=true;
		...
		public void Actval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateLandTrackDisused6016D.ActFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Act )
           		{
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateLandTrackDisused6016D.ActFlag=true;
	      	repo.ListRealView.Self.Items[1].Select();
       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		public void Stypeval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateLandTrackDisused6016D.StypeFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Stype )
           		{
        	...
        	if (!found)
        	{
        	ValidateTrack.ValidateLandTrackDisused6016D.StypeFlag=true;
          	repo.ListRealView.Self.Items[1].Select();
       		repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		static CreateLandTrackDisused6016D()
		{
