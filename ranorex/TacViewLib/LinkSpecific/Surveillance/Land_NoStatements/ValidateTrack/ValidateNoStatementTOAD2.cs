...
namespace TacViewLib.LinkSpecific.Surveillance.Land_NoStatements.ValidateTrack_POINT
{
	...
	public partial class ValidateNoStatementTOAD2
	{
		...
		public static void Start()
		{
			...
			Delay.Milliseconds(100000, false);
			...
			Delay.Milliseconds(0);
			ValidateNoStatementTOAD2.Validate_ListItemPlatform();
			Delay.Milliseconds(250);
			ValidateNoStatementTOAD2.Validate_ListItemActivity();
			Delay.Milliseconds(250);
			ValidateNoStatementTOAD2.Validate_ListItemStype();
			Delay.Milliseconds(250);
