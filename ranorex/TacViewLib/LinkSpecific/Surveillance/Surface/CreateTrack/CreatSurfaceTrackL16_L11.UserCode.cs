...
{
    public partial class CreatSurfaceTrackL16_L11
    {
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMainCreate.ListItemIdentity);  
		   			...
		   			ValidateTrack.ValidateSurfaceTrackL16_L11.ID = IDValue;
		   			Report.Info("Identity Entered = " + IDValue);
		   			ValidateTrack.ValidateSurfaceTrackL16_L11.ID_OOR = false;
		   			x=2;
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSurfaceTrackL16_L11.ID_OOR = true;
			   		}
				}			
			}
		}
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMainCreate.ListItemPlatform);  
		   			...
		   			ValidateTrack.ValidateSurfaceTrackL16_L11.Plat = PlatValue;
		   			Report.Info("Platform Value Entered = " + PlatValue);
		   			ValidateTrack.ValidateSurfaceTrackL16_L11.Plat_OOR = false;
		   			x=2;
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSurfaceTrackL16_L11.Plat_OOR = true;
			   		}
				}					
			}
		}		
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMainCreate.ListItemActivity);  
		   			...
		   			ValidateTrack.ValidateSurfaceTrackL16_L11.Act = ActValue;
		   			Report.Info("Activity Value Entered = " + ActValue);
		   			ValidateTrack.ValidateSurfaceTrackL16_L11.Act_OOR = false;
		   			x=2;
				}
				catch (ArgumentOutOfRangeException e)
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSurfaceTrackL16_L11.Act_OOR = true;
			   		}
				}					
			}
		}		
...
//		   			ValidateTrack.ValidateSurfaceTrackL16_L11.Stype = StypeValue;
//		   			Report.Info("Specific Type Value Entered = " + StypeValue);
//		   			ValidateTrack.ValidateSurfaceTrackL16_L11.Stype_OOR = false;
//		   			x=2;
//				}
//				catch (ArgumentOutOfRangeException e)
//				{								   			
...
//			   			Report.Debug(e.ToString());	
//			   			ValidateTrack.ValidateSurfaceTrackL16_L11.Stype_OOR = true;
//			   		}
//				}				
//			}
		}			
		...
		{			
			...
			string track1 = accElement.Name;
	 		...
	 		ValidateTrack.ValidateSurfaceTrackL16_L11.TrackNum = track1;
