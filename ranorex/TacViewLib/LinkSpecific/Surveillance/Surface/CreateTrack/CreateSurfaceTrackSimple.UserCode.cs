...
namespace TacViewLib.LinkSpecific.Surveillance.Surface.CreateTrack
{
	...
	public partial class CreateSurfaceTrackSimple
	{		
			...
			while (x < 2)
			{
				try
				{
					...
					Accessible accElement = new Accessible(repo.FormMainCreate.ListItemIdentity);  
		   			...
		   			ValidateTrack.ValidateSurfaceTrackSimple.ID = IDValue;
		   			Report.Info("Identity Entered = " + IDValue);
		   			ValidateTrack.ValidateSurfaceTrackSimple.ID_OOR = false;
		   			x=2;
				}
				...
				{								   			
			   		...
			   		else if (x == 2)
			   		{
			   			...
			   			Report.Debug(e.ToString());	
			   			ValidateTrack.ValidateSurfaceTrackSimple.ID_OOR = true;
			   		}
				}			
			}
		}
		...
		{			
			try
			{
			    ...
			    Accessible accElement = new Accessible(pic1);
	   			...
	   			ValidateTrack.ValidateSurfaceTrackSimple.TrackNum = track1;
	   			Drop_Track.DropTrack.TrackNum = track1;   	 
			}
			catch (Exception)
            {
				ValidateTrack.ValidateSurfaceTrackSimple.ExitFlag1 = true;
				ValidateTrack.ValidateSurfaceTrackSimple.ExitFlag2 = true;
		...
		static CreateSurfaceTrackSimple()
		{
