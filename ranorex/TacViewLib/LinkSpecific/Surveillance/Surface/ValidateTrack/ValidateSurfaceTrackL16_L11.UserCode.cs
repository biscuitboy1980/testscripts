...
{
    public partial class ValidateSurfaceTrackL16_L11
 	{
		...
		{
			Accessible accElement = new Accessible(repo.FormMain__Surface_TN.ListItemSource_Type);  
		...
		public void ValidateTrackType()
		{
			if (Link11 == true)
			{
				Report.Info("Validating AttributeEqual (AccessibleValue='L11 Surface') on item 'FormMain__Surface_TN.ListItemTrack_Type'.");
				Validate.Attribute(repo.FormMain__Surface_TN.ListItemTrack_TypeInfo, "AccessibleValue", "L11 Surface", Validate.DefaultMessage, false);	
			}
			else
			{
				Report.Info("Validating AttributeEqual (AccessibleValue='Surface') on item 'FormMain__Surface_TN.ListItemTrack_Type'.");
		...
		//************************************************************************************//
		//*****************Validates Surface ID, Platform, and Activity Value*****************//
		//************************************************************************************//
		...
		public void ValidateSurface()
		{
			...
			{				
				...
				ForwardingFunctions.Convert_SurfaceL16_L11(ID, Plat, Act, out L11ID, out L11PriAmp, out L11IDAmp);					
				...
				if (Link11 == true)
				{
					Report.Info("Validating AttributeEqual (Text='(ID)') on item 'repo.FormMain__Surface_TN.ListItemIdentityInfo'.");
					Validate.Attribute(repo.FormMain__Surface_TN.ListItemIdentityInfo, "AccessibleValue", L11ID, Validate.DefaultMessage, false);
					Report.Info("Validating AttributeEqual (Text='(Pri Amp)') on item 'repo.FormMain__Surface_TN.ListItemPriAmpInfo'.");
					Validate.Attribute(repo.FormMain__Surface_TN.ListItemPriAmpInfo, "AccessibleValue", L11PriAmp, Validate.DefaultMessage, false);
					Report.Info("Validating AttributeEqual (Text='(ID Amp)') on item 'repo.FormMain__Surface_TN.ListItemIDAmpInfo'.");
					Validate.Attribute(repo.FormMain__Surface_TN.ListItemIDAmpInfo, "AccessibleValue", L11IDAmp, Validate.DefaultMessage, false);
				}
				else
				{
					CommonUtilLib.Forwarding ForwardingFunctions1 = new CommonUtilLib.Forwarding();
					ForwardingFunctions1.Convert_SurfaceL11_L16(L11ID, L11PriAmp, L11IDAmp, out L16ID, out L16Plat, out L16Act);						
					Report.Info("Validating AttributeEqual (Text='(ID)') on item 'repo.FormMain__Surface_TN.ListItemIdentityInfo'.");
					Validate.Attribute(repo.FormMain__Surface_TN.ListItemIdentityInfo, "AccessibleValue", L16ID, Validate.DefaultMessage, false);
					Report.Info("Validating AttributeEqual (Text='(Platform)') on item 'repo.FormMain__Surface_TN.ListItemPlatformInfo'.");
					Validate.Attribute(repo.FormMain__Surface_TN.ListItemPlatformInfo, "AccessibleValue", L16Plat, Validate.DefaultMessage, false);
					Report.Info("Validating AttributeEqual (Text='(Activity)') on item 'repo.FormMain__Surface_TN.ListItemActivityInfo'.");
					Validate.Attribute(repo.FormMain__Surface_TN.ListItemActivityInfo, "AccessibleValue", L16Act, Validate.DefaultMessage, false);
				}
			}
		}			
