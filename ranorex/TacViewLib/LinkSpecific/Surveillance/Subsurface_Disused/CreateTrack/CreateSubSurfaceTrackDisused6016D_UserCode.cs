...
namespace TacViewLib.LinkSpecific.Surveillance.Subsurface_Disused.CreateTrack
{
	...
	public partial class CreateSubSurfaceTrackDisused6016D
	{
		...
		public void IDval()
		{
			repo.FormMain__SubSurface_TN___CREATING.ListItemIdentity.Click("CenterLeft");
			...
			Accessible accElement = new Accessible(repo.FormMain__SubSurface_TN___CREATING.ListItemIdentity);  
   			string IDValue = accElement.Value;
   			ValidateTrack.ValidateSubSurfaceTrackDisused6016D.ID = IDValue;
		}
		...
		public void Platval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSubSurfaceTrackDisused6016D.PlatFlag=false;
        	...
        	if (!found)
        	{
        	 ValidateTrack.ValidateSubSurfaceTrackDisused6016D.PlatFlag=true;
		...
		public void Actval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSubSurfaceTrackDisused6016D.ActFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Act )
           		{
        	...
        	if (!found)
        	{
        	 ValidateTrack.ValidateSubSurfaceTrackDisused6016D.ActFlag=true;
           	 repo.ListRealView.Self.Items[1].Select();
       		 repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		public void Stypeval()
		{
			Keyboard.Press("{LMenu down}{Down}{LMenu up}");
			bool found = false;
			ValidateTrack.ValidateSubSurfaceTrackDisused6016D.StypeFlag=false;
        	foreach( ListItem item in repo.ListRealView.Self.Items )
        	{
           		if ( item.Text == Stype )
           		{
        	...
        	if (!found)
        	{
        	 ValidateTrack.ValidateSubSurfaceTrackDisused6016D.StypeFlag=true;
           	 repo.ListRealView.Self.Items[1].Select();
       		 repo.ListRealView.Self.Items[1].Click();
        	}   
		}
		...
		static CreateSubSurfaceTrackDisused6016D()
		{
