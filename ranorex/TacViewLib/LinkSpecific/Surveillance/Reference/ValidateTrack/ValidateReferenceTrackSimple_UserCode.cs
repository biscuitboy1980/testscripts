...
{
	public partial class ValidateReferenceTrackSimple
	{
		...
		public void ValidateAmp()
		{
			if (!ExitFlag2)
			{
				if (!Amp_OOR)
				{
					Report.Info("Validating AttributeEqu矔l (Text='(Amplification)') on item 'FormMain__Reference_Point_TN.ListItemAmplification'.");
