...
namespace TacViewLib.LinkSpecific.Surveillance.Surface_NoStatements.ValidateTrack
{
	...
	public partial class ValidateResetNoStatementTOAD2
	{
		...
		public void Validate_ListItemPlatform1()
		{
			...
			Validate.Attribute(repo.FormMain__Surface_TN.ListItemPlatformInfo, "AccessibleValue", "RESET TO NO STATEMENT", Validate.DefaultMessage, false);
		}
		...
		public void Validate_ListItemActivity1()
		{
			//Your code here. Code inside this method will not be changed by the code generator.
			Report.Info("Validating Specific Type = RESET TO NO STATEMENT");
			Validate.Attribute(repo.FormMain__Surface_TN.ListItemActivityInfo, "AccessibleValue", "RESET TO NO STATEMENT", Validate.DefaultMessage, false);
		}
		...
		public void Validate_ListItemStype1()
		{
			//Your code here. Code inside this method will not be changed by the code generator.
			Report.Info("Validating Specific Type = RESET TO NO STATEMENT");
			Validate.Attribute(repo.FormMain__Surface_TN.ListItemStypeInfo, "AccessibleValue", "RESET TO NO STATEMENT", Validate.DefaultMessage, false);
		}
		...
		public void Validate_ListItemPlatform2()
		{
			...
			Validate.Attribute(repo.FormMain__Surface_TN.ListItemPlatformInfo, "AccessibleValue", "N.S.", Validate.DefaultMessage, false);
		}
