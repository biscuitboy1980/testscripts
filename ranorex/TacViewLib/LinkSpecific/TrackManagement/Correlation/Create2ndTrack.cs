...
namespace TacViewLib.LinkSpecific.TrackManagement.Correlation
{
    ...
    /// </summary>
    [TestModule("9bbdf1e5-e4d4-4edb-9205-0e055a791c8d", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormCreate_Track.MenuItemConnection2' at Center.", repo.FormCreate_Track.MenuItemConnection2Info, new RecordItemIndex(3));
            repo.FormCreate_Track.MenuItemConnection2.Click(100);
            Delay.Milliseconds(150);
