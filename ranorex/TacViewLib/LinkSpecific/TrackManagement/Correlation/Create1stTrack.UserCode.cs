	...
	{		
		...
		{			
		    ...
		    Accessible pic1 = @"/form[@title~'^TacViewC2\ \ \ \(map:\ .*']/element/container/picture[@accessiblevalue='Track']" + "[" + TCount + "]";
   			...
   			Correlation.CorrelateTracks.track1 = track1;
   			Correlation.ValidateCorrelation.track1 = track1;
        ...
        public void TrackType()
        {
			...
			TacViewLib.LinkSpecific.TrackManagement.Correlation.Create2ndTrack.ASnum = ASnum;            			
        }			
