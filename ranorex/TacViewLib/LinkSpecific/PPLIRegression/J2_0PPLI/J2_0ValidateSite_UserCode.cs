...
namespace TacViewLib.LinkSpecific.PPLIRegression.J2_0PPLI
{
	...
	/// </summary>
	public partial class J2_0ValidateSite
	{		
		//Variables
		...
		//************************************************************************************//
		//*****************************Validates Specific Type********************************//
		//************************************************************************************//
				
		public void ValidateSpecificType()
		{
			if (!SpecType_OOO)
			{
				Report.Info("Validating AttributeEqual (Text='(SpecType)') on item 'repo.FormMain__Site_TN.ListItemSpecific_TypeInfo'.");
				Report.Info("Value Entered = " + SpecType);
				Validate.Attribute(repo.FormMain__Site_TN.ListItemSpecific_TypeInfo, "AccessibleValue", SpecType.ToUpper(), Validate.DefaultMessage, false);
			}
		}		
		...
		public void ValidateSiteType()
		{
			if (!SiteType_OOO)
			{
				Report.Info("Validating AttributeEqual (Text='(SpecType)') on item 'repo.FormMain__Site_TN.ListItemSite_TypeInfo'.");
				Report.Info("Value Entered = " + SiteType);
				Validate.Attribute(repo.FormMain__Site_TN.ListItemSite_TypeInfo, "AccessibleValue", SiteType, Validate.DefaultMessage, false);
			}
		}		
		
		//************************************************************************************//
		//****************************Validates Generic Unit Type*****************************//
		//************************************************************************************//
				
		public void ValidateGenericUnitType()
		{
			if (!GenericUnitType_OOO)
			{
				Report.Info("Validating AttributeEqual (Text='(GenericUnitType)') on item 'repo.FormMain__Site_TN.ListItemGeneric_Unit_TypeInfo'.");
				Report.Info("Value Entered = " + GenericUnitType);
				Validate.Attribute(repo.FormMain__Site_TN.ListItemGeneric_Unit_TypeInfo, "AccessibleValue", GenericUnitType, Validate.DefaultMessage, false);
			}
		}		
...
//			}
		...
		public void ValidateIndirectIndicator()
		{
			...
			Report.Info("Value Entered = Indirect");
			Validate.Attribute(repo.FormMain__Site_TN.ListItemIndirect_IndicatorInfo, "AccessibleValue", "Indirect", Validate.DefaultMessage, false);
		}	
		
		//************************************************************************************//
		//******************************Validates Active Indicator****************************//
		//************************************************************************************//
				
		public void ValidateActiveIndicator()
		{
			if (!ActiveInd_OOO)
			{
				Report.Info("Validating AttributeEqual (Text='(ActiveInd)') on item 'repo.FormMain__Site_TN.ListItemActive_IndicatorInfo'.");
				Report.Info("Value Entered = " + ActiveInd);
				Validate.Attribute(repo.FormMain__Site_TN.ListItemActive_IndicatorInfo, "AccessibleValue", ActiveInd, Validate.DefaultMessage, false);
			}
		}
