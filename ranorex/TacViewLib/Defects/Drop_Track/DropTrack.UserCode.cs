	...
	{	
		...
		{			
			...
			if (repo.FormRealView.MenuItemTracksInfo.Exists())
			{
				...
				Report.Info("Mouse Right Click item 'FormRealView.MenuItemTracks'");
		        ...
		        repo.FormTracks.MenuItemC2_HOST_Track.Click();
		       	Report.Info("Mouse Left Click item 'FormTOAD.MenuItemDrop_Track'");
				repo.FormC2_HOST.MenuItemDrop_Track.Click();
				repo.FormRealView1.ButtonYes.Click();
			}
			
			else if (repo.FormRealView.MenuItemTrackNumberInfo.Exists())
			{
				Report.Info("Dropping Track # " + TrackNum);
			    Report.Info("Mouse Right Click item 'repo.FormRealView.MenuItemTrackNumber'");
